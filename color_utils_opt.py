...
def create_hdf5_file():
    ...
    source_data = other_utils_opt.rgb2gray(target_data)
    test_source_data = other_utils_opt.rgb2gray(test_target_data)
    ...
    filenames = ('color_test_source.png', 'color_test_target.png')
    titles = ('CIFAR10 test source images', 'CIFAR10 test target images')

    return other_utils_opt.create_hdf5_file(data, titles, filenames, 'input_gray_color_60000.hdf5')